...
class LoadingState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg.frames = Paths.getSparrowAtlas('funkay');
		bg.antialiasing = true;
		bg.animation.addByPrefix('idle', 'funkyn', 24);
		...
		add(loadBar);	
		//ese -59694 es el color de la barra morada se puede cambiar XD

		logo = new FlxSprite(500, -150);
