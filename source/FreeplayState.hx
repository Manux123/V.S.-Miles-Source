...
class FreeplayState extends MusicBeatState
{
	...
	//tienes que agregar un color para el freeplay cada canción tiene un color si no lo agregas el fondo estara negro
	...
	override function create()
	{
		...
		if (StoryMenuState.weekUnlocked[1] || isDebug)
			addWeek(['A calm fox', 'Alerious', 'Energy Max'], 1, ['miles', 'miles', 'miles_energymax']);
