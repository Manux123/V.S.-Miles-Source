...
{
	static inline final MIDDLESCROLL = "MiddleScroll ";
	...
	public override function press():Bool
	{
		FlxG.save.data.puto = !FlxG.save.data.puto;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return MIDDLESCROLL + (!FlxG.save.data.puto ? "on" : "off");
	}
}
...
class MidScrollOption extends Option
{
	public function new(desc:String)
		...
		public override function press():Bool
		{
			FlxG.save.data.splash = !FlxG.save.data.mid;
			display = updateDisplay();
			return true;
		}
		private override function updateDisplay():String
		{
			return "MidScroll " + (!FlxG.save.data.mid ? "off" : "on");
		}
}
